"Generated by gen_cdef.py from ghostty 88b4cd0. Do not edit."
...
typedef enum {
    ...
    GHOSTTY_NO_VALUE = -4,
    GHOSTTY_RESULT_MAX_VALUE = 0x7FFFFFFF,
} GhosttyResult;
...
typedef enum {
  ...
  GHOSTTY_FORMATTER_FORMAT_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_OPTIMIZE_MODE_MAX_VALUE = 0x7FFFFFFF,
} GhosttyOptimizeMode;
...
typedef enum {
  ...
  GHOSTTY_BUILD_INFO_MAX_VALUE = 0x7FFFFFFF,
} GhosttyBuildInfo;
...
typedef enum {
    ...
    GHOSTTY_COLOR_SCHEME_MAX_VALUE = 0x7FFFFFFF,
} GhosttyColorScheme;
...
typedef enum {
    ...
    GHOSTTY_FOCUS_MAX_VALUE = 0x7FFFFFFF,
} GhosttyFocusEvent;
...
typedef enum {
  ...
  GHOSTTY_CELL_CONTENT_TAG_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_CELL_WIDE_MAX_VALUE = 0x7FFFFFFF,
} GhosttyCellWide;
...
typedef enum {
  ...
  GHOSTTY_CELL_SEMANTIC_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_CELL_DATA_MAX_VALUE = 0x7FFFFFFF,
} GhosttyCellData;
...
typedef enum {
  ...
  GHOSTTY_ROW_SEMANTIC_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_ROW_DATA_MAX_VALUE = 0x7FFFFFFF,
} GhosttyRowData;
...
typedef enum {
  ...
  GHOSTTY_STYLE_COLOR_TAG_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_POINT_TAG_MAX_VALUE = 0x7FFFFFFF,
  } GhosttyPointTag;
...
typedef enum {
  ...
  GHOSTTY_SELECTION_ORDER_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_SELECTION_ADJUST_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_SELECTION_GESTURE_BEHAVIOR_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_SELECTION_GESTURE_AUTOSCROLL_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_SELECTION_GESTURE_DATA_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_SELECTION_GESTURE_EVENT_TYPE_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_SELECTION_GESTURE_EVENT_OPT_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
    ...
    GHOSTTY_MODE_REPORT_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
    ...
    GHOSTTY_SIZE_REPORT_STYLE_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_TERMINAL_COMPRESSION_MODE_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_TERMINAL_COMPRESSION_RESULT_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_SCROLL_VIEWPORT_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_TERMINAL_SCREEN_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_TERMINAL_CURSOR_STYLE_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_CLIPBOARD_LOCATION_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_CLIPBOARD_WRITE_RESULT_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_TERMINAL_OPT_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_TERMINAL_DATA_MAX_VALUE = 0x7FFFFFFF,
} GhosttyTerminalData;
...
typedef enum {
  ...
  GHOSTTY_RENDER_STATE_DIRTY_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_RENDER_STATE_CURSOR_VISUAL_STYLE_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_RENDER_STATE_DATA_MAX_VALUE = 0x7FFFFFFF,
} GhosttyRenderStateData;

typedef enum {
  
  GHOSTTY_RENDER_STATE_OPTION_DIRTY = 0,
  GHOSTTY_RENDER_STATE_OPTION_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_RENDER_STATE_ROW_DATA_MAX_VALUE = 0x7FFFFFFF,
} GhosttyRenderStateRowData;

typedef enum {
  
  GHOSTTY_RENDER_STATE_ROW_OPTION_DIRTY = 0,
  GHOSTTY_RENDER_STATE_ROW_OPTION_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_RENDER_STATE_ROW_CELLS_DATA_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_OSC_COMMAND_TYPE_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_OSC_DATA_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_SGR_ATTR_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_SGR_UNDERLINE_MAX_VALUE = 0x7FFFFFFF,
} GhosttySgrUnderline;
...
typedef enum {
    ...
    GHOSTTY_SYS_LOG_LEVEL_MAX_VALUE = 0x7FFFFFFF,
} GhosttySysLogLevel;
...
typedef enum {
    ...
    GHOSTTY_SYS_OPT_MAX_VALUE = 0x7FFFFFFF,
} GhosttySysOption;
...
typedef enum {
    ...
    GHOSTTY_KEY_ACTION_MAX_VALUE = 0x7FFFFFFF,
} GhosttyKeyAction;
...
typedef enum {
    ...
    GHOSTTY_KEY_CUT,
    GHOSTTY_KEY_PASTE,
    GHOSTTY_KEY_MAX_VALUE = 0x7FFFFFFF,
} GhosttyKey;
...
typedef enum {
    ...
    GHOSTTY_OPTION_AS_ALT_MAX_VALUE = 0x7FFFFFFF,
} GhosttyOptionAsAlt;
...
typedef enum {
  ...
  GHOSTTY_MOUSE_ACTION_MAX_VALUE = 0x7FFFFFFF,
} GhosttyMouseAction;
...
typedef enum {
  ...
  GHOSTTY_MOUSE_BUTTON_MAX_VALUE = 0x7FFFFFFF,
} GhosttyMouseButton;
...
typedef enum {
  ...
  GHOSTTY_MOUSE_TRACKING_MAX_VALUE = 0x7FFFFFFF,
...
typedef enum {
  ...
  GHOSTTY_MOUSE_FORMAT_MAX_VALUE = 0x7FFFFFFF,
} GhosttyMouseFormat;
...
typedef enum {
  ...
  GHOSTTY_MOUSE_ENCODER_OPT_MAX_VALUE = 0x7FFFFFFF,
